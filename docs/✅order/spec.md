...
将来 [docs/✅nautilus_trader/](../✅nautilus_trader/) Phase N2 で nautilus `LiveExecutionClient` に切り替えるとき、本計画で書く Python レイヤを **そのまま nautilus に組み込める**ことを設計目標とする。これに反する実装は禁止:
