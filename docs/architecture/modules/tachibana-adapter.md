---
title: Tachibana adapter モジュール構造
status: migrated
migrated_from:
  - docs/✅tachibana/architecture.md
...
| [docs/specs/data-engine/](../specs/data-engine/) `schemas/` | `commands.json` / `events.json` に新コマンド・イベントを記載、`CHANGELOG.md` 更新（※親計画ディレクトリ内のスキーマ。本計画 T0 で同期） |
