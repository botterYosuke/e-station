...
status: migrated
migrated_from:
  - docs/✅tachibana/open-questions.md
...
Q21 表行の詳細セクション（アンカー `#q21--demo-環境の運用時間` / 旧アンカー `#L25` 互換）。implementation-plan.md L248 / L617 から参照される `open-questions.md#L25` の死活アンカーを生かすため、Q21 行に明示見出しを与える。実機確認結果が出たら本セクション配下に追記し、spec.md §4 / implementation-plan.md T7 にも反映する。
