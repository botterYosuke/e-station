---
title: 立花注文機能 Open Questions
status: migrated
migrated_from:
  - docs/✅order/open-questions.md
...
**Q10 も同時確定**: e-station 内 `docs/specs/backtest/spec.md` を正本とし、
...
**決定**: **案 A** — e-station 内 `docs/specs/backtest/spec.md` を正本とし、
