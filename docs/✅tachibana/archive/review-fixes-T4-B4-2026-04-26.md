...
### 本ドキュメント担当の修正範囲
- `docs/✅tachibana/implementation-plan.md` §T4 (B5 繰越行) に H2 callsite 明記を追記
- `docs/✅tachibana/implementation-plan.md` §T4 末尾に H3 Phase 1 reconnect モデルの設計仮定を新項目として追加
- `docs/✅tachibana/implementation-plan.md` §T7 に M3 `capabilities_changed_after_reconnect` pin test 追加予定を新項目として追加
- 本ログ末尾に R3 セクションを追記
