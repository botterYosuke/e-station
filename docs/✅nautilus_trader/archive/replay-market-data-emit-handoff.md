...
`bash scripts/run-replay-debug.sh examples/buy_and_hold.py` 実行時に、
...
- `bash scripts/run-replay-debug.sh examples/buy_and_hold.py` を実行し、
...
- E2E 手動: `bash scripts/run-replay-debug.sh examples/buy_and_hold.py` で
