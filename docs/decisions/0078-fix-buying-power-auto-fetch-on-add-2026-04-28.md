---
id: 0078
title: "Fix Buying Power Auto Fetch On Add 2026 04 28"
status: deferred
date: 2026-05-08
...
原本は `docs/✅order/archive/fix-buying-power-auto-fetch-on-add-2026-04-28.md` (commit `f62bf94`) に存在する。本文起票は git 履歴から内容を参照して行う。
