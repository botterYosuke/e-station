...
| 計画 | 関係 |
|------|------|
| [docs/plan/✅python-data-engine/](../✅python-data-engine/) | IPC・エンジン側への影響なし。Rust GUI のみの変更 |
| [docs/plan/nautilus_trader/](../nautilus_trader/) | D9（REPLAY 銘柄追加時の自動 pane 生成）が本計画の `WindowAdded` / `FloatingPane` API に依存する |
