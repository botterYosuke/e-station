...
>
> 関連: [phase-7-ui-regression-remediation.md](../✅python-data-engine/archive/phase-7-ui-regression-remediation.md) §T4.d
...
再評価時は本ドキュメントを更新し、必要であれば `docs/` 配下に独立 phase として計画を起こす。
