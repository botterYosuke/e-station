...
- Use `strategic-compact` when the failure came from context overflow — compact before retrying.
- Escalate to the user when the failure is high-risk or requires external intervention.
