...
## 2026-05-12 ? kabu_station �u�ۗL�����v���u�X�V���v�̂܂܉i�v��~

**�������p�^�[��**: IPC outbox dict �� proto �����������؁i�p�^�[�� #44�j

**�s��̊T�v**:
live ���[�h�ŗ��ԃ��O�A�E�g �� kabuStation ���O�C�� ��Ԃɂ����āA
�u�ۗL�����v�p�l�����u? �X�V���c�v�����ؐi�W���Ȃ��B

**���{����**:
`server.py::_do_get_positions_kabu` �� outbox �ɐς� `position_type` �t�B�[���h��
`"LONG"` / `"SHORT"` �Ƃ����s���Ȓl���g���Ă����B

`schemas.py::PositionRecord` �� Literal �� `"cash"` / `"margin_credit"` / `"margin_general"` ��
3 �l���������Ă��Ȃ��B�܂� `venue` Literal �� `"tachibana"` / `"replay"` �݂̂ŁA
`"kabu_station"` ���������Ă����B

`server_grpc.py::_dict_to_proto_event` �� `ParseDict` �� `ignore_unknown_fields=False` �œ��삷�邽�߁A
`position_type="LONG"` ���󂯎��� proto �ϊ��Ɏ��s�� `Failed to build proto Event PositionsUpdated: ... ? dropping`
�ƂȂ��� event �� silently dropped�B
���ʂƂ��� Rust ���� PositionsUpdated ���͂����A`loading=true` ���i�v�ɉ�������Ȃ��B

**�C��**:

| �t�@�C�� | �ύX���e |
|---------|---------|
| `python/engine/schemas.py::PositionRecord.venue` | `"kabu_station"` �� Literal �ɒǉ� |
| `python/engine/server.py::_do_get_positions_kabu` | `position_type` �� `"cash"` / `"margin_credit"` / `"margin_general"` �Ɏʑ��B`Side=="1"` �� short �Ƃ��� `qty` ���}�C�i�X���B`ExecutionID` �� `tategyoku_id` �Ɋi�[ |

**�Ȃ������e�X�g�Ŕ����ł��Ȃ�������**:

| �e�X�g | �����������R |
|--------|------------|
| `test_kabusapi_rest.py` | REST �N���C�A���g�P�́Boutbox �y�C���[�h�t�H�[�}�b�g�����؂��Ă��Ȃ� |
| `test_tachibana_positions_dispatch.py` | ���� (tachibana venue) �p�X�̂݃J�o�[ |
| `test_server_dispatch.py` | GetPositions �R�}���h�� kabu_station ���[�g���e�X�g���Ă��Ȃ� |
| proto �ϊ��e�X�g | PositionsUpdated dict �� proto �ϊ��� kabu �t�H�[�}�b�g�Ő������邩�����؂���e�X�g���Ȃ����� |

**�ǉ������e�X�g**:
- `python/tests/test_kabu_positions_payload.py::test_kabu_positions_produces_valid_protobuf_enum_variants`
  ? `_do_get_positions_kabu` �� `position_type` �� valid �� Literal ���g���Ashort �͕� qty �ɂȂ邱�Ƃ� assert

**���O���b�V�����m�F**: `position_type="LONG"/"SHORT"` �ɖ߂��ƐV�e�X�g�� ValidationError �� FAIL ���邱�Ƃ��m�F�B�C���� PASS�B

**���P**:

1. **outbox dict �� enum �t�B�[���h�� PositionRecord schema �Əƍ�����e�X�g������**:
   `ParseDict(ignore_unknown_fields=False)` �͕s���� enum ������ŃC�x���g�� drop ����B
   outbox �ɐς� dict �� `PositionRecord(**fields)` �Ńo���f�[�V�������邩�Aproto �ϊ������� integration test �Ŋm�F����B

2. **�V venue �ǉ����� schemas.py �̑S Literal �t�B�[���h�𓯎��Ɋm�F����**:
   `grep -n "Literal.*venue\|venue.*Literal" python/engine/schemas.py` �őS�ӏ����m�F���A
   �V venue �������ׂĂ� Literal �ɒǉ�����B

3. **proto silently drop �̃f�o�b�O�w�j**:
   `Failed to build proto Event XXX: ... ? dropping` ���O�������B
   smoke.sh �� FAIL �����ɂ��̃��O�p�^�[����ǉ����邱�Ƃ���������B
